...
This file defines package boundaries inside `:chir:chir-tree`.
...
- Test-only fixtures and diff-report helpers are kept under `chir/chir-tree/tests/.../testkit` and are not production API.
