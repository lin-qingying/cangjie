...
flowchart LR
    ...
    P8 --> B1["CFIR2CHIR<br/>:chir:cfir2chir"]
...
| 后端       | `:chir:chir-tree`、`:chir:cfir2chir`、`:compiler:codegen`、`:compiler:jvm-codegen`、`:llvm-interop`、`:llvm-interop:llvm-interop-api`、`:llvm-interop:llvm-interop-jni`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
