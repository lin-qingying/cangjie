 ...
 */
class CaBuiltinsVirtualFileProviderCliImplTest {
    @Test
    fun discoverStdlibFilesFromSystemProperty() {
        withEnvironment {
            ...
            try {
                ...
                val provider = CaBuiltinsVirtualFileProviderCliImpl()
    ...
    private fun withEnvironment(action: () -> Unit) {
        val disposable = Disposer.newDisposable("CaBuiltinsVirtualFileProviderCliImplTest")
        try {
