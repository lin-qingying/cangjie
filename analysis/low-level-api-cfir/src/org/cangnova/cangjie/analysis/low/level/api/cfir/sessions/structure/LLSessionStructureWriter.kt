...
/**
 * [LLSessionStructureWriter] writes a GraphML graph of [LLCfirSession]s which is used to visualize and analyze the structure of cached
...
object LLSessionStructureWriter {
     ...
     */
    fun writeSessionStructure(storage: LLCfirSessionCacheStorage, analysisRoots: List<LLCfirSession>, writer: BufferedWriter) {
