...
abstract class ContextByDesignationCollector<C : Any>(private val designation: CfirDesignation) {
...
private class CfirDesignationState(val designation: CfirDesignation) {
    /**
