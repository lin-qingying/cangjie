...
private fun CaDiagnosticConverterBuilder.addConversions2() {
    add(CfirErrors.DEPRECATED_ARGUMENT_DUPLICATION) { cfirDiagnostic ->
        DeprecatedArgumentDuplicationImpl(
            cfirDiagnostic.a,
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
...
private fun CaDiagnosticConverterBuilder.addConversions7() {
    add(CfirErrors.POINTER_SINGLE_ELEMENT_TYPE_ERROR) { cfirDiagnostic ->
        PointerSingleElementTypeErrorImpl(
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
    }
...
private fun CaDiagnosticConverterBuilder.addConversions8() {
    ...
    add(CfirErrors.RETURN_TYPE_INVARIANCE) { cfirDiagnostic ->
        ReturnTypeInvarianceImpl(
            cfirDiagnostic.a,
            cfirSymbolBuilder.typeBuilder.buildType(cfirDiagnostic.b),
            cfirDiagnostic as CjPsiDiagnostic,
            token,
...
private fun CaDiagnosticConverterBuilder.addConversions11() {
    ...
    add(CfirErrors.DEPRECATED_ARGUMENTS_MUST_BE_LITERAL_CONST) { cfirDiagnostic ->
        DeprecatedArgumentsMustBeLiteralConstImpl(
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
    }
...
private fun CaDiagnosticConverterBuilder.addConversions13() {
    add(CfirErrors.ILLEGAL_ACCESS_NON_STATIC_MEMBER) { cfirDiagnostic ->
        IllegalAccessNonStaticMemberImpl(
            cfirDiagnostic.a,
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
...
private fun CaDiagnosticConverterBuilder.addConversions20() {
    add(CfirErrors.CFUNC_CANNOT_HAVE_NAMED_ARGS) { cfirDiagnostic ->
        CfuncCannotHaveNamedArgsImpl(
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
    }
...
private fun CaDiagnosticConverterBuilder.addConversions21() {
    ...
    add(CfirErrors.UNSAFE_FUNCTION_INVOKE_FAILED) { cfirDiagnostic ->
        UnsafeFunctionInvokeFailedImpl(
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
    }
...
private fun CaDiagnosticConverterBuilder.addConversions23() {
    ...
    add(CfirErrors.THIS_SUPER_USE_ERROR_OUTSIDE_CLASS) { cfirDiagnostic ->
        ThisSuperUseErrorOutsideClassImpl(
            cfirDiagnostic.a,
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
...
private fun CaDiagnosticConverterBuilder.addConversions28() {
    add(CfirErrors.IGNORE_OPEN) { cfirDiagnostic ->
        IgnoreOpenImpl(
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
    ...
    add(CfirErrors.DEPRECATED_UNKNOWN_ARGUMENT) { cfirDiagnostic ->
        DeprecatedUnknownArgumentImpl(
            cfirDiagnostic.a,
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
...
private fun CaDiagnosticConverterBuilder.addConversions31() {
    add(CfirErrors.FUNC_CAPTURE_VAR_NOT_CTYPE) { cfirDiagnostic ->
        FuncCaptureVarNotCtypeImpl(
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
    }
    add(CfirErrors.POINTER_TOO_MUCH_ARGUMENT) { cfirDiagnostic ->
        PointerTooMuchArgumentImpl(
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
    }
...
private fun CaDiagnosticConverterBuilder.addConversions38() {
    add(CfirErrors.OPERATOR_OVERLOAD_BUILT_IN_BINARY_OPERATOR) { cfirDiagnostic ->
        OperatorOverloadBuiltInBinaryOperatorImpl(
            cfirDiagnostic.a,
            cfirDiagnostic.b,
            cfirDiagnostic.c,
            cfirDiagnostic as CjPsiDiagnostic,
...
private fun CaDiagnosticConverterBuilder.addConversions41() {
    ...
    add(CfirErrors.CFUNC_CTOR_MUST_BE_CPOINTER) { cfirDiagnostic ->
        CfuncCtorMustBeCpointerImpl(
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
    }
...
private fun CaDiagnosticConverterBuilder.addConversions50() {
    add(CfirErrors.ABSTRACT_METHOD_CANNOT_BE_ACCESSED_DIRECTLY) { cfirDiagnostic ->
        AbstractMethodCannotBeAccessedDirectlyImpl(
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
    }
    ...
    add(CfirErrors.GENERIC_INFINITE_INSTANTIATION) { cfirDiagnostic ->
        GenericInfiniteInstantiationImpl(
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
    }
...
private fun CaDiagnosticConverterBuilder.addConversions53() {
    add(CfirErrors.MULTIPLE_PRIMARY_CONSTRUCTORS) { cfirDiagnostic ->
        MultiplePrimaryConstructorsImpl(
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
    }
...
private fun CaDiagnosticConverterBuilder.addConversions55() {
    ...
    add(CfirErrors.DEPRECATED_WRONG_ARGUMENT) { cfirDiagnostic ->
        DeprecatedWrongArgumentImpl(
            cfirDiagnostic.a,
            cfirDiagnostic.b,
            cfirDiagnostic as CjPsiDiagnostic,
            token,
...
private fun CaDiagnosticConverterBuilder.addConversions62() {
    ...
    add(CfirErrors.NEED_MEMBER_IMPLEMENTATION) { cfirDiagnostic ->
        NeedMemberImplementationImpl(
            cfirDiagnostic.a,
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
...
private fun CaDiagnosticConverterBuilder.addConversions65() {
    ...
    add(CfirErrors.CFUNC_TYPE) { cfirDiagnostic ->
        CfuncTypeImpl(
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
...
private fun CaDiagnosticConverterBuilder.addConversions71() {
    add(CfirErrors.NO_MATCH_FUNCTION_DECLARATION_FOR_CALL) { cfirDiagnostic ->
        NoMatchFunctionDeclarationForCallImpl(
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
    }
...
private fun CaDiagnosticConverterBuilder.addConversions72() {
    add(CfirErrors.CAPTURE_HAS_SHADOW_VARIABLE) { cfirDiagnostic ->
        CaptureHasShadowVariableImpl(
            cfirDiagnostic.a,
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
    }
    add(CfirErrors.STATIC_AND_NON_STATIC_MEMBER_CANNOT_HAVE_SAME_NAME) { cfirDiagnostic ->
        StaticAndNonStaticMemberCannotHaveSameNameImpl(
            cfirDiagnostic.a,
            cfirDiagnostic.b,
            cfirDiagnostic.c,
            cfirDiagnostic.d,
...
private fun CaDiagnosticConverterBuilder.addConversions74() {
    add(CfirErrors.INVALID_ACCESS_CONTROL) { cfirDiagnostic ->
        InvalidAccessControlImpl(
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
    }
    add(CfirErrors.CFUNC_TOO_MANY_ARGUMENTS) { cfirDiagnostic ->
        CfuncTooManyArgumentsImpl(
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
    }
...
private fun CaDiagnosticConverterBuilder.addConversions77() {
    add(CfirErrors.THIS_OR_SUPER_NOT_ALLOWED_TO_INITIALIZE_NON_STATIC_MEMBER) { cfirDiagnostic ->
        ThisOrSuperNotAllowedToInitializeNonStaticMemberImpl(
            cfirDiagnostic.a,
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
...
private fun CaDiagnosticConverterBuilder.addConversions86() {
    add(CfirErrors.ILLEGAL_PLACE_OF_CALLING_THIS_PRIMARY_CONSTRUCTOR) { cfirDiagnostic ->
        IllegalPlaceOfCallingThisPrimaryConstructorImpl(
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
    }
...
private fun CaDiagnosticConverterBuilder.addConversions91() {
    ...
    add(CfirErrors.NO_NON_PARAM_CONSTRUCTOR_IN_SUPER_CLASS) { cfirDiagnostic ->
        NoNonParamConstructorInSuperClassImpl(
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
    }
...
private fun CaDiagnosticConverterBuilder.addConversions92() {
    add(CfirErrors.STATIC_VARIABLE_CANNOT_ACCESS_NON_STATIC_MEMBER) { cfirDiagnostic ->
        StaticVariableCannotAccessNonStaticMemberImpl(
            cfirDiagnostic.a,
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
...
private fun CaDiagnosticConverterBuilder.addConversions96() {
    ...
    add(CfirErrors.DEPRECATED_EMPTY_STRING_ARGUMENT) { cfirDiagnostic ->
        DeprecatedEmptyStringArgumentImpl(
            cfirDiagnostic.a,
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
...
private fun CaDiagnosticConverterBuilder.addConversions105() {
    ...
    add(CfirErrors.ILLEGAL_MEMBER_OF_CSTRUCT) { cfirDiagnostic ->
        IllegalMemberOfCstructImpl(
            cfirDiagnostic.a,
            cfirDiagnostic.b,
            cfirDiagnostic as CjPsiDiagnostic,
            token,
...
private fun CaDiagnosticConverterBuilder.addConversions108() {
    add(CfirErrors.ILLEGAL_THIS_OUTSIDE_STRUCT_CONSTRUCTOR) { cfirDiagnostic ->
        IllegalThisOutsideStructConstructorImpl(
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
    }
...
private fun CaDiagnosticConverterBuilder.addConversions119() {
    ...
    add(CfirErrors.ANNOTATION_INVALID_ARGS_TYPE) { cfirDiagnostic ->
        AnnotationInvalidArgsTypeImpl(
            cfirDiagnostic.a,
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
...
private fun CaDiagnosticConverterBuilder.addConversions120() {
    add(CfirErrors.NOT_A_TYPE) { cfirDiagnostic ->
        NotATypeImpl(
            cfirDiagnostic.a,
            cfirDiagnostic as CjPsiDiagnostic,
            token,
...
private fun CaDiagnosticConverterBuilder.addConversions121() {
    add(CfirErrors.ILLEGAL_USE_OF_ANNOTATION) { cfirDiagnostic ->
        IllegalUseOfAnnotationImpl(
            cfirDiagnostic.a,
            cfirDiagnostic.b,
            cfirDiagnostic as CjPsiDiagnostic,
            token,
...
private fun CaDiagnosticConverterBuilder.addConversions126() {
    add(CfirErrors.OPERATOR_OVERLOAD_BUILT_IN_UNARY_OPERATOR) { cfirDiagnostic ->
        OperatorOverloadBuiltInUnaryOperatorImpl(
            cfirDiagnostic.a,
            cfirDiagnostic.b,
            cfirDiagnostic as CjPsiDiagnostic,
            token,
...
private fun CaDiagnosticConverterBuilder.addConversions128() {
    ...
    add(CfirErrors.STATIC_FUNCTION_CANNOT_ACCESS_NON_STATIC_MEMBER) { cfirDiagnostic ->
        StaticFunctionCannotAccessNonStaticMemberImpl(
            cfirDiagnostic.a,
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
...
private fun CaDiagnosticConverterBuilder.addConversions130() {
    add(CfirErrors.ILLEGAL_SUPER_ALONE) { cfirDiagnostic ->
        IllegalSuperAloneImpl(
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
    }
    add(CfirErrors.ILLEGAL_PLACE_OF_CALLING_THIS_OR_SUPER) { cfirDiagnostic ->
        IllegalPlaceOfCallingThisOrSuperImpl(
            cfirDiagnostic.a,
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
...
private fun CaDiagnosticConverterBuilder.addConversions134() {
    ...
    add(CfirErrors.UNUSED_VARIABLE) { cfirDiagnostic ->
        UnusedVariableImpl(
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
...
private fun CaDiagnosticConverterBuilder.addConversions144() {
    add(CfirErrors.INTRINSIC_FUNCTION_MUST_BE_TOPLEVEL) { cfirDiagnostic ->
        IntrinsicFunctionMustBeToplevelImpl(
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
    }
...
private fun CaDiagnosticConverterBuilder.addConversions154() {
    add(CfirErrors.INTRINSIC_FUNCTION_CANNOT_HAVE_BODY) { cfirDiagnostic ->
        IntrinsicFunctionCannotHaveBodyImpl(
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
    }
    add(CfirErrors.UNUSED_FUNCTION) { cfirDiagnostic ->
        UnusedFunctionImpl(
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
...
private fun CaDiagnosticConverterBuilder.addConversions155() {
    add(CfirErrors.ANNOTATION_CALLING_CONV_NOT_SUPPORT) { cfirDiagnostic ->
        AnnotationCallingConvNotSupportImpl(
            cfirDiagnostic.a,
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
...
private fun CaDiagnosticConverterBuilder.addConversions157() {
    ...
    add(CfirErrors.INCOMPATIBLE_MUT_MODIFIER_BETWEEN_STRUCT_AND_INTERFACE) { cfirDiagnostic ->
        IncompatibleMutModifierBetweenStructAndInterfaceImpl(
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
    }
...
private fun CaDiagnosticConverterBuilder.addConversions162() {
    add(CfirErrors.INVALID_THIS_CALL_OUTSIDE_CTOR) { cfirDiagnostic ->
        InvalidThisCallOutsideCtorImpl(
            cfirDiagnostic.a,
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
...
private fun CaDiagnosticConverterBuilder.addConversions166() {
    ...
    add(CfirErrors.THIS_OR_SUPER_NOT_ALLOWED_TO_INITIALIZE_STATIC_MEMBER) { cfirDiagnostic ->
        ThisOrSuperNotAllowedToInitializeStaticMemberImpl(
            cfirDiagnostic.a,
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
...
private fun CaDiagnosticConverterBuilder.addConversions171() {
    ...
    add(CfirErrors.DEPRECATED_INVALID_TARGET) { cfirDiagnostic ->
        DeprecatedInvalidTargetImpl(
            cfirDiagnostic.a,
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
...
private fun CaDiagnosticConverterBuilder.addConversions172() {
    add(CfirErrors.INHERITANCE_CYCLE) { cfirDiagnostic ->
        InheritanceCycleImpl(
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
    }
...
private fun CaDiagnosticConverterBuilder.addConversions178() {
    add(CfirErrors.CFUNC_CANNOT_CAPTURE_THIS) { cfirDiagnostic ->
        CfuncCannotCaptureThisImpl(
            cfirDiagnostic.a,
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
...
private fun CaDiagnosticConverterBuilder.addConversions179() {
    add(CfirErrors.CFUNC_CANNOT_HAVE_UNIT_ARGS) { cfirDiagnostic ->
        CfuncCannotHaveUnitArgsImpl(
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
    }
...
private fun CaDiagnosticConverterBuilder.addConversions183() {
    add(CfirErrors.THIS_AS_EXPRESSION_IN_FUNC) { cfirDiagnostic ->
        ThisAsExpressionInFuncImpl(
            cfirDiagnostic.a,
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
...
private fun CaDiagnosticConverterBuilder.addConversions187() {
    add(CfirErrors.CFUNC_CANNOT_CAPTURE_VAR) { cfirDiagnostic ->
        CfuncCannotCaptureVarImpl(
            cfirDiagnostic.a,
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
    }
    add(CfirErrors.INTERFACE_MEMBER_MUST_BE_IMPLEMENTED) { cfirDiagnostic ->
        InterfaceMemberMustBeImplementedImpl(
            cfirDiagnostic.a,
            cfirDiagnostic.b,
            cfirDiagnostic.c,
            cfirDiagnostic as CjPsiDiagnostic,
...
private fun CaDiagnosticConverterBuilder.addConversions189() {
    add(CfirErrors.STATIC_MEMBERS_CANNOT_CALL_MEMBERS) { cfirDiagnostic ->
        StaticMembersCannotCallMembersImpl(
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
    }
...
private fun CaDiagnosticConverterBuilder.addConversions194() {
    add(CfirErrors.ILLEGAL_MEMBER_USED_IN_OPEN_CONSTRUCTOR) { cfirDiagnostic ->
        IllegalMemberUsedInOpenConstructorImpl(
            cfirDiagnostic.a,
            cfirDiagnostic.b,
            cfirDiagnostic.c,
            cfirDiagnostic as CjPsiDiagnostic,
...
private fun CaDiagnosticConverterBuilder.addConversions198() {
    add(CfirErrors.CFFI_CANNOT_HAVE_TYPE_PARAM) { cfirDiagnostic ->
        CffiCannotHaveTypeParamImpl(
            cfirDiagnostic.a,
            cfirDiagnostic as CjPsiDiagnostic,
            token,
        )
