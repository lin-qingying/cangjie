...
class CfirStandaloneDependentScriptSourceModuleImportOptimizationPlanTestGenerated : AbstractImportOptimizationPlanTest() {
    ...
    fun testAllFilesPresentInModel() {
        CjTestUtil.assertAllTestsPresentByMetadata(
            ...
            Pattern.compile("^importOptimization\\.cjs$"),
            true,
        )
    }

    @TestMetadata("importOptimization.cjs")
    @Test
    fun testImportOptimization() {
        runTest("analysis/analysis-api/testData/components/imports/importOptimization/importOptimization.cjs")
    }
}
