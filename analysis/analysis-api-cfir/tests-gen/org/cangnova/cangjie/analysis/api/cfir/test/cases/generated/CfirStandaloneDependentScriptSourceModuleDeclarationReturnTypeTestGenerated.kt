...
class CfirStandaloneDependentScriptSourceModuleDeclarationReturnTypeTestGenerated : AbstractDeclarationReturnTypeTest() {
    ...
    fun testAllFilesPresentInModel() {
        CjTestUtil.assertAllTestsPresentByMetadata(
            ...
            Pattern.compile("^declarationReturnType\\.cjs$"),
            true,
        )
    }

    @TestMetadata("declarationReturnType.cjs")
    @Test
    fun testDeclarationReturnType() {
        runTest("analysis/analysis-api/testData/components/expressionTypeProvider/declarationReturnType/declarationReturnType.cjs")
    }
}
