...
class CfirLspCompatibleNormalLibraryFallbackDependenciesModuleReferenceShortenerForWholeFileTestGenerated : AbstractReferenceShortenerForWholeFileTest() {
    ...
    fun testAllFilesPresentInModel() {
        CjTestUtil.assertAllTestsPresentByMetadata(
            this::class.java,
            File("analysis/analysis-api/testData/components/references/shortenWholeFile"),
            Pattern.compile("^shortenWholeFile\\.cj$"),
            true,
        )
    }
    ...
    @Test
    fun testShortenWholeFile() {
        runTest("analysis/analysis-api/testData/components/references/shortenWholeFile/shortenWholeFile.cj")
    }
}
