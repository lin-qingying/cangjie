...
class CfirLspCompatibleNormalLibraryFallbackDependenciesModuleSymbolPointerRestoreTestGenerated : AbstractSymbolPointerRestoreTest() {
    ...
    fun testAllFilesPresentInModel() {
        CjTestUtil.assertAllTestsPresentByMetadata(
            this::class.java,
            File("analysis/analysis-api/testData/sessions/symbolPointers"),
            Pattern.compile("^symbolPointerRestore\\.cj$"),
            true,
        )
    }
    ...
    @Test
    fun testSymbolPointerRestore() {
        runTest("analysis/analysis-api/testData/sessions/symbolPointers/symbolPointerRestore.cj")
    }
}
