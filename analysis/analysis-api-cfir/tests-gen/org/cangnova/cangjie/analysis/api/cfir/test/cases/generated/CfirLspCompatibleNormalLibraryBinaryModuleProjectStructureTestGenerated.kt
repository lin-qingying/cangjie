...
class CfirLspCompatibleNormalLibraryBinaryModuleProjectStructureTestGenerated : AbstractModuleStructureTest() {
    ...
    fun testAllFilesPresentInModel() {
        CjTestUtil.assertAllTestsPresentByMetadata(
            this::class.java,
            File("analysis/analysis-api/testData/projectStructure/moduleKinds/libraryBinary"),
            Pattern.compile("^libraryBinary\\.cj$"),
            true,
        )
    }
    ...
    @Test
    fun testLibraryBinary() {
        runTest("analysis/analysis-api/testData/projectStructure/moduleKinds/libraryBinary/libraryBinary.cj")
    }
}
