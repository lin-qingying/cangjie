...
class CfirLspCompatibleNormalLibraryFallbackDependenciesModuleSymbolRenderingByReferenceTestGenerated : AbstractSymbolRenderingByReferenceTest() {
    ...
    fun testAllFilesPresentInModel() {
        CjTestUtil.assertAllTestsPresentByMetadata(
            this::class.java,
            File("analysis/analysis-api/testData/components/symbolDeclarationRenderer/symbolRenderingByReference"),
            Pattern.compile("^.+\\.cj$"),
            true,
        )
    }
    ...
    fun testExtendMemberReference() {
        runTest("analysis/analysis-api/testData/components/symbolDeclarationRenderer/symbolRenderingByReference/extendMemberReference.cj")
    }

    @TestMetadata("functionReference.cj")
    @Test
    fun testFunctionReference() {
        runTest("analysis/analysis-api/testData/components/symbolDeclarationRenderer/symbolRenderingByReference/functionReference.cj")
    }
}
