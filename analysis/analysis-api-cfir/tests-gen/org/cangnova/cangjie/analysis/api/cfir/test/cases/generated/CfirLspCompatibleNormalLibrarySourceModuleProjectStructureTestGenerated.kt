...
class CfirLspCompatibleNormalLibrarySourceModuleProjectStructureTestGenerated : AbstractModuleStructureTest() {
    ...
    fun testAllFilesPresentInModel() {
        CjTestUtil.assertAllTestsPresentByMetadata(
            this::class.java,
            File("analysis/analysis-api/testData/projectStructure/moduleKinds/librarySource"),
            Pattern.compile("^librarySource\\.cj$"),
            true,
        )
    }
    ...
    fun testLibrarySource() {
        runTest("analysis/analysis-api/testData/projectStructure/moduleKinds/librarySource/librarySource.cj")
    }
}
