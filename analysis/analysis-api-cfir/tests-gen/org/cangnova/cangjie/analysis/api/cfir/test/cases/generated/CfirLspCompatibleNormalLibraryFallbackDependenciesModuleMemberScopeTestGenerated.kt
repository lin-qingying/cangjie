...
class CfirLspCompatibleNormalLibraryFallbackDependenciesModuleMemberScopeTestGenerated : AbstractMemberScopeTest() {
    ...
    fun testAllFilesPresentInModel() {
        CjTestUtil.assertAllTestsPresentByMetadata(
            this::class.java,
            File("analysis/analysis-api/testData/components/scopeProvider/memberScope"),
            Pattern.compile("^memberScopeQueries\\.cj$"),
            true,
        )
    }
    ...
    @Test
    fun testMemberScopeQueries() {
        runTest("analysis/analysis-api/testData/components/scopeProvider/memberScope/memberScopeQueries.cj")
    }
}
