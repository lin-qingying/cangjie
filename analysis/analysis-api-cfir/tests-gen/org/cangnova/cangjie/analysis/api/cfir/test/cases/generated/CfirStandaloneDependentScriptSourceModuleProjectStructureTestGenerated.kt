...
@TestMetadata("analysis/analysis-api/testData/projectStructure/moduleKinds/scriptSource")
class CfirStandaloneDependentScriptSourceModuleProjectStructureTestGenerated : AbstractModuleStructureTest() {
    ...
    fun testAllFilesPresentInModel() {
        CjTestUtil.assertAllTestsPresentByMetadata(
            this::class.java,
            File("analysis/analysis-api/testData/projectStructure/moduleKinds/scriptSource"),
            Pattern.compile("^scriptSource\\.cjs$"),
            true,
        )
    }

    @TestMetadata("scriptSource.cjs")
    @Test
    fun testScriptSource() {
        runTest("analysis/analysis-api/testData/projectStructure/moduleKinds/scriptSource/scriptSource.cjs")
    }
}
