...
class CfirLspCompatibleNormalLibraryFallbackDependenciesModuleDefaultImportsTestGenerated : AbstractDefaultImportsTest() {
    ...
    fun testAllFilesPresentInModel() {
        CjTestUtil.assertAllTestsPresentByMetadata(
            this::class.java,
            File("analysis/analysis-api/testData/components/imports/defaultImports"),
            Pattern.compile("^defaultImports\\.cj$"),
            true,
        )
    }
    ...
    @Test
    fun testDefaultImports() {
        runTest("analysis/analysis-api/testData/components/imports/defaultImports/defaultImports.cj")
    }
}
