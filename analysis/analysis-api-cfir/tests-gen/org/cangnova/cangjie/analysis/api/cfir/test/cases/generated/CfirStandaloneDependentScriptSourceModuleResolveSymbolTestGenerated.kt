...
class CfirStandaloneDependentScriptSourceModuleResolveSymbolTestGenerated : AbstractResolveSymbolTest() {
    ...
    fun testAllFilesPresentInModel() {
        CjTestUtil.assertAllTestsPresentByMetadata(
            ...
            Pattern.compile("^resolveSymbol\\.cjs$"),
            true,
        )
    }

    @TestMetadata("resolveSymbol.cjs")
    @Test
    fun testResolveSymbol() {
        runTest("analysis/analysis-api/testData/components/resolver/singleByPsi/resolveSymbol.cjs")
    }
}
