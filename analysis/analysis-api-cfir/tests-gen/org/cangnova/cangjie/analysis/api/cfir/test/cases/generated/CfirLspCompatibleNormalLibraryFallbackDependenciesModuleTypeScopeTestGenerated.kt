...
class CfirLspCompatibleNormalLibraryFallbackDependenciesModuleTypeScopeTestGenerated : AbstractTypeScopeTest() {
    ...
    fun testAllFilesPresentInModel() {
        CjTestUtil.assertAllTestsPresentByMetadata(
            this::class.java,
            File("analysis/analysis-api/testData/components/scopeProvider/typeScope"),
            Pattern.compile("^typeScopeQueries\\.cj$"),
            true,
        )
    }
    ...
    @Test
    fun testTypeScopeQueries() {
        runTest("analysis/analysis-api/testData/components/scopeProvider/typeScope/typeScopeQueries.cj")
    }
}
