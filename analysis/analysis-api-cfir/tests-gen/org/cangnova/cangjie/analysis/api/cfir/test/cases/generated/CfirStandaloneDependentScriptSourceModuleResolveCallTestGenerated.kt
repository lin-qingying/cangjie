...
class CfirStandaloneDependentScriptSourceModuleResolveCallTestGenerated : AbstractResolveCallTest() {
    ...
    fun testAllFilesPresentInModel() {
        CjTestUtil.assertAllTestsPresentByMetadata(
            ...
            Pattern.compile("^memberCallInfo\\.cjs$"),
            true,
        )
    }

    @TestMetadata("memberCallInfo.cjs")
    @Test
    fun testMemberCallInfo() {
        runTest("analysis/analysis-api/testData/components/resolver/singleByPsi/memberCallInfo.cjs")
    }
}
