...
class CfirLspCompatibleNormalLibraryFallbackDependenciesModuleTopLevelSymbolProviderTestGenerated : AbstractTopLevelSymbolProviderTest() {
    ...
    fun testAllFilesPresentInModel() {
        CjTestUtil.assertAllTestsPresentByMetadata(
            this::class.java,
            File("analysis/analysis-api/testData/components/symbolProvider/topLevelLookup"),
            Pattern.compile("^topLevelLookup\\.cj$"),
            true,
        )
    }
    ...
    @Test
    fun testTopLevelLookup() {
        runTest("analysis/analysis-api/testData/components/symbolProvider/topLevelLookup/topLevelLookup.cj")
    }
}
