...
class CfirLspCompatibleNormalBuiltinsModuleProjectStructureTestGenerated : AbstractModuleStructureTest() {
    ...
    fun testAllFilesPresentInModel() {
        CjTestUtil.assertAllTestsPresentByMetadata(
            this::class.java,
            File("analysis/analysis-api/testData/projectStructure/moduleKinds/builtins"),
            Pattern.compile("^builtins\\.cj$"),
            true,
        )
    }
    ...
    @Test
    fun testBuiltins() {
        runTest("analysis/analysis-api/testData/projectStructure/moduleKinds/builtins/builtins.cj")
    }
}
