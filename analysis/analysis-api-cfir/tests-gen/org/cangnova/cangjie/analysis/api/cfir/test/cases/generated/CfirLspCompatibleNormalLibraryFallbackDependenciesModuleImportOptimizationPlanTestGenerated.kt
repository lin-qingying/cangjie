...
class CfirLspCompatibleNormalLibraryFallbackDependenciesModuleImportOptimizationPlanTestGenerated : AbstractImportOptimizationPlanTest() {
    ...
    fun testAllFilesPresentInModel() {
        CjTestUtil.assertAllTestsPresentByMetadata(
            this::class.java,
            File("analysis/analysis-api/testData/components/imports/importOptimization"),
            Pattern.compile("^importOptimization\\.cj$"),
            true,
        )
    }
    ...
    @Test
    fun testImportOptimization() {
        runTest("analysis/analysis-api/testData/components/imports/importOptimization/importOptimization.cj")
    }
}
