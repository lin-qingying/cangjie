...
class CfirStandaloneDependentScriptSourceModuleMemberScopeTestGenerated : AbstractMemberScopeTest() {
    ...
    fun testAllFilesPresentInModel() {
        CjTestUtil.assertAllTestsPresentByMetadata(
            ...
            Pattern.compile("^memberScopeQueries\\.cjs$"),
            true,
        )
    }

    @TestMetadata("memberScopeQueries.cjs")
    @Test
    fun testMemberScopeQueries() {
        runTest("analysis/analysis-api/testData/components/scopeProvider/memberScope/memberScopeQueries.cjs")
    }
}
