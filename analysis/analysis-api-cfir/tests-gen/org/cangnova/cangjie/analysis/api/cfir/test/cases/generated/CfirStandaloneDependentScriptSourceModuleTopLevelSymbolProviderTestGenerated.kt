...
class CfirStandaloneDependentScriptSourceModuleTopLevelSymbolProviderTestGenerated : AbstractTopLevelSymbolProviderTest() {
    ...
    fun testAllFilesPresentInModel() {
        CjTestUtil.assertAllTestsPresentByMetadata(
            ...
            Pattern.compile("^topLevelLookup\\.cjs$"),
            true,
        )
    }

    @TestMetadata("topLevelLookup.cjs")
    @Test
    fun testTopLevelLookup() {
        runTest("analysis/analysis-api/testData/components/symbolProvider/topLevelLookup/topLevelLookup.cjs")
    }
}
