...
class CfirStandaloneDependentScriptSourceModuleTypePointerConsistencyTestGenerated : AbstractTypePointerConsistencyTest() {
    ...
    fun testAllFilesPresentInModel() {
        CjTestUtil.assertAllTestsPresentByMetadata(
            ...
            Pattern.compile("^typePointerRestoration\\.cjs$"),
            true,
        )
    }

    @TestMetadata("typePointerRestoration.cjs")
    @Test
    fun testTypePointerRestoration() {
        runTest("analysis/analysis-api/testData/types/typePointers/consistency/typePointerRestoration.cjs")
    }
}
