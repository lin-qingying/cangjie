...
class CfirStandaloneDependentScriptSourceModuleReferenceShorteningPlanTestGenerated : AbstractReferenceShorteningPlanTest() {
    ...
    fun testAllFilesPresentInModel() {
        CjTestUtil.assertAllTestsPresentByMetadata(
            ...
            Pattern.compile("^referenceShortening\\.cjs$"),
            true,
        )
    }

    @TestMetadata("referenceShortening.cjs")
    @Test
    fun testReferenceShortening() {
        runTest("analysis/analysis-api/testData/components/references/referenceShortening/referenceShortening.cjs")
    }
}
