...
class CfirStandaloneDependentScriptSourceModulePackageScopeTestGenerated : AbstractPackageScopeTest() {
    ...
    fun testAllFilesPresentInModel() {
        CjTestUtil.assertAllTestsPresentByMetadata(
            ...
            Pattern.compile("^packageScopeQueries\\.cjs$"),
            true,
        )
    }

    @TestMetadata("packageScopeQueries.cjs")
    @Test
    fun testPackageScopeQueries() {
        runTest("analysis/analysis-api/testData/components/scopeProvider/packageScope/packageScopeQueries.cjs")
    }
}
