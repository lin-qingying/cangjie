...
class CfirStandaloneDependentCodeFragmentModuleProjectStructureTestGenerated : AbstractModuleStructureTest() {
    ...
    fun testAllFilesPresentInModel() {
        CjTestUtil.assertAllTestsPresentByMetadata(
            this::class.java,
            File("analysis/analysis-api/testData/projectStructure/moduleKinds/codeFragment"),
            Pattern.compile("^codeFragment\\.cj$"),
            true,
        )
    }
    ...
    fun testCodeFragment() {
        runTest("analysis/analysis-api/testData/projectStructure/moduleKinds/codeFragment/codeFragment.cj")
    }
}
