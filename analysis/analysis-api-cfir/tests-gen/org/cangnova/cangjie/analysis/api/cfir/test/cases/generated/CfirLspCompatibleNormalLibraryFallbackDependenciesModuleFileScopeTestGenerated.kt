...
class CfirLspCompatibleNormalLibraryFallbackDependenciesModuleFileScopeTestGenerated : AbstractFileScopeTest() {
    ...
    fun testAllFilesPresentInModel() {
        CjTestUtil.assertAllTestsPresentByMetadata(
            this::class.java,
            File("analysis/analysis-api/testData/components/scopeProvider/fileScope"),
            Pattern.compile("^fileScopeQueries\\.cj$"),
            true,
        )
    }
    ...
    @Test
    fun testFileScopeQueries() {
        runTest("analysis/analysis-api/testData/components/scopeProvider/fileScope/fileScopeQueries.cj")
    }
}
