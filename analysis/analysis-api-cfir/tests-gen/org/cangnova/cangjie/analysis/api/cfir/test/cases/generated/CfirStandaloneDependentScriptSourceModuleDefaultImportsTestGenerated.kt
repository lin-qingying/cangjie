...
class CfirStandaloneDependentScriptSourceModuleDefaultImportsTestGenerated : AbstractDefaultImportsTest() {
    ...
    fun testAllFilesPresentInModel() {
        CjTestUtil.assertAllTestsPresentByMetadata(
            ...
            Pattern.compile("^defaultImports\\.cjs$"),
            true,
        )
    }

    @TestMetadata("defaultImports.cjs")
    @Test
    fun testDefaultImports() {
        runTest("analysis/analysis-api/testData/components/imports/defaultImports/defaultImports.cjs")
    }
}
