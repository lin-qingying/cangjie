...
class CfirLspCompatibleNormalLibraryFallbackDependenciesModuleSymbolByReferenceTestGenerated : AbstractSymbolByReferenceTest() {
    ...
    fun testAllFilesPresentInModel() {
        CjTestUtil.assertAllTestsPresentByMetadata(
            this::class.java,
            File("analysis/analysis-api/testData/symbols/symbolByReference"),
            Pattern.compile("^.+\\.cj$"),
            true,
        )
    }
    ...
    fun testFunctionReference() {
        runTest("analysis/analysis-api/testData/symbols/symbolByReference/functionReference.cj")
    }

    @TestMetadata("patternBindingReference.cj")
    @Test
    fun testPatternBindingReference() {
        runTest("analysis/analysis-api/testData/symbols/symbolByReference/patternBindingReference.cj")
    }
}
