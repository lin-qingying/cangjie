...
class CfirLspCompatibleNormalLibraryFallbackDependenciesModulePackageScopeTestGenerated : AbstractPackageScopeTest() {
    ...
    fun testAllFilesPresentInModel() {
        CjTestUtil.assertAllTestsPresentByMetadata(
            this::class.java,
            File("analysis/analysis-api/testData/components/scopeProvider/packageScope"),
            Pattern.compile("^packageScopeQueries\\.cj$"),
            true,
        )
    }
    ...
    @Test
    fun testPackageScopeQueries() {
        runTest("analysis/analysis-api/testData/components/scopeProvider/packageScope/packageScopeQueries.cj")
    }
}
