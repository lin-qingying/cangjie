...
class CfirLspCompatibleNormalLibraryFallbackDependenciesModuleResolveCallTestGenerated : AbstractResolveCallTest() {
    ...
    fun testAllFilesPresentInModel() {
        CjTestUtil.assertAllTestsPresentByMetadata(
            ...
            Pattern.compile("^memberCallInfo\\.cj$"),
            true,
        )
    }
    ...
    @Test
    fun testMemberCallInfo() {
        runTest("analysis/analysis-api/testData/components/resolver/singleByPsi/memberCallInfo.cj")
    }
}
