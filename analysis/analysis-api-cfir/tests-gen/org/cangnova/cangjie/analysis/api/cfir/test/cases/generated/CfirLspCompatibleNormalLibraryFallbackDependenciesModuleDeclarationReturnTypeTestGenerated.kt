...
class CfirLspCompatibleNormalLibraryFallbackDependenciesModuleDeclarationReturnTypeTestGenerated : AbstractDeclarationReturnTypeTest() {
    ...
    fun testAllFilesPresentInModel() {
        CjTestUtil.assertAllTestsPresentByMetadata(
            this::class.java,
            File("analysis/analysis-api/testData/components/expressionTypeProvider/declarationReturnType"),
            Pattern.compile("^declarationReturnType\\.cj$"),
            true,
        )
    }
    ...
    @Test
    fun testDeclarationReturnType() {
        runTest("analysis/analysis-api/testData/components/expressionTypeProvider/declarationReturnType/declarationReturnType.cj")
    }
}
