...
class CfirStandaloneDependentScriptSourceModuleSignatureSubstitutionTestGenerated : AbstractSignatureSubstitutionTest() {
    ...
    fun testAllFilesPresentInModel() {
        CjTestUtil.assertAllTestsPresentByMetadata(
            ...
            Pattern.compile("^signatureSubstitution\\.cjs$"),
            true,
        )
    }

    @TestMetadata("signatureSubstitution.cjs")
    @Test
    fun testSignatureSubstitution() {
        runTest("analysis/analysis-api/testData/components/substitutors/signatureSubstitution/signatureSubstitution.cjs")
    }
}
