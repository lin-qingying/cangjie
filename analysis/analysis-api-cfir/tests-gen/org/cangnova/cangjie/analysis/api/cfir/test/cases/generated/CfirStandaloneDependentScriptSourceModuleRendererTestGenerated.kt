...
class CfirStandaloneDependentScriptSourceModuleRendererTestGenerated : AbstractRendererTest() {
    ...
    fun testAllFilesPresentInModel() {
        CjTestUtil.assertAllTestsPresentByMetadata(
            ...
            Pattern.compile("^basicRendering\\.cjs$"),
            true,
        )
    }

    @TestMetadata("basicRendering.cjs")
    @Test
    fun testBasicRendering() {
        runTest("analysis/analysis-api/testData/components/renderer/basicRendering/basicRendering.cjs")
    }
}
