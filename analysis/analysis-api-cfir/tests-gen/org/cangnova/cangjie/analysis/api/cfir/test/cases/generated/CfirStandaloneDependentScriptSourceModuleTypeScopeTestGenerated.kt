...
class CfirStandaloneDependentScriptSourceModuleTypeScopeTestGenerated : AbstractTypeScopeTest() {
    ...
    fun testAllFilesPresentInModel() {
        CjTestUtil.assertAllTestsPresentByMetadata(
            ...
            Pattern.compile("^typeScopeQueries\\.cjs$"),
            true,
        )
    }

    @TestMetadata("typeScopeQueries.cjs")
    @Test
    fun testTypeScopeQueries() {
        runTest("analysis/analysis-api/testData/components/scopeProvider/typeScope/typeScopeQueries.cjs")
    }
}
