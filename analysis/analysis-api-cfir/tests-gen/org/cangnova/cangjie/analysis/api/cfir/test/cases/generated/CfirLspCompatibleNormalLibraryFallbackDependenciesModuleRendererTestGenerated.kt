...
class CfirLspCompatibleNormalLibraryFallbackDependenciesModuleRendererTestGenerated : AbstractRendererTest() {
    ...
    fun testAllFilesPresentInModel() {
        CjTestUtil.assertAllTestsPresentByMetadata(
            this::class.java,
            File("analysis/analysis-api/testData/components/renderer/basicRendering"),
            Pattern.compile("^basicRendering\\.cj$"),
            true,
        )
    }
    ...
    fun testBasicRendering() {
        runTest("analysis/analysis-api/testData/components/renderer/basicRendering/basicRendering.cj")
    }
}
