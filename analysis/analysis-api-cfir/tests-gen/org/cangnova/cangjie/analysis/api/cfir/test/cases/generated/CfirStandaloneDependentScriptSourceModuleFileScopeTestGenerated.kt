...
class CfirStandaloneDependentScriptSourceModuleFileScopeTestGenerated : AbstractFileScopeTest() {
    ...
    fun testAllFilesPresentInModel() {
        CjTestUtil.assertAllTestsPresentByMetadata(
            ...
            Pattern.compile("^fileScopeQueries\\.cjs$"),
            true,
        )
    }

    @TestMetadata("fileScopeQueries.cjs")
    @Test
    fun testFileScopeQueries() {
        runTest("analysis/analysis-api/testData/components/scopeProvider/fileScope/fileScopeQueries.cjs")
    }
}
