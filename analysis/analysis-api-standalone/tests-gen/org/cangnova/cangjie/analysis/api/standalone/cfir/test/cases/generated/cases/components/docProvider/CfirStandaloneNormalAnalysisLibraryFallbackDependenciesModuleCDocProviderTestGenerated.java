...
package org.cangnova.cangjie.analysis.api.standalone.cfir.test.cases.generated.cases.components.docProvider;
...
public class CfirStandaloneNormalAnalysisLibraryFallbackDependenciesModuleCDocProviderTestGenerated extends AbstractCDocProviderTest {
  @NotNull
  @Override
  ...
  private void run(String fileName) {
    runTest("analysis/analysis-api/testData/components/docProvider/cdoc/" + fileName);
  }

  @Test
  public void testAllFilesPresentInCdoc() {
    CjTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("analysis/analysis-api/testData/components/docProvider/cdoc"), Pattern.compile("^(.+)\\.cj$"), null, true);
  }

  @Test
  @TestMetadata("cdoc.cj")
  public void testCdoc() {
    run("cdoc.cj");
  }
}
