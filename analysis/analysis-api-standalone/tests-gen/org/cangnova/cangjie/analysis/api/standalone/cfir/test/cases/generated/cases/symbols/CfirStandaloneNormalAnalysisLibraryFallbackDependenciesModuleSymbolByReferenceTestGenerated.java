...
package org.cangnova.cangjie.analysis.api.standalone.cfir.test.cases.generated.cases.symbols;
...
public class CfirStandaloneNormalAnalysisLibraryFallbackDependenciesModuleSymbolByReferenceTestGenerated extends AbstractSymbolByReferenceTest {
  @NotNull
  @Override
  ...
  public void testAllFilesPresentInSymbolByReference() {
    CjTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("analysis/analysis-api/testData/symbols/symbolByReference"), Pattern.compile("^(.+)\\.cj$"), null, true);
  }
