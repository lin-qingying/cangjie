...
public class CfirStandaloneNormalAnalysisLibraryBinaryModuleSymbolByFqNameTestGenerated extends AbstractSymbolByFqNameTest {
  @NotNull
  @Override
  ...
  public void testAllFilesPresentInSymbolByFqName() {
    CjTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("analysis/analysis-api/testData/symbols/symbolByFqName"), Pattern.compile("^(.+)\\.cj$"), null, true);
  }

  @Test
  @TestMetadata("topLevelSymbols.cj")
  public void testTopLevelSymbols() {
    run("topLevelSymbols.cj");
  }
}
