...
public class CfirStandaloneNormalAnalysisLibraryBinaryModuleSingleSymbolByPsiTestGenerated extends AbstractSingleSymbolByPsiTest {
  @NotNull
  @Override
  ...
  public void testAllFilesPresentInSingleSymbolByPsi() {
    CjTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("analysis/analysis-api/testData/symbols/singleSymbolByPsi"), Pattern.compile("^(.+)\\.cj$"), null, true);
  }
