...
@TestMetadata("analysis/analysis-api/testData/symbols/packages")
@TestDataPath("$PROJECT_ROOT")
public class CfirStandaloneNormalAnalysisSourceModulePackageSymbolTestGenerated extends AbstractPackageSymbolTest {
  @NotNull
  @Override
  ...
  public void testAllFilesPresentInPackages() {
    CjTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("analysis/analysis-api/testData/symbols/packages"), Pattern.compile("^(.+)\\.cj$"), null, true);
  }
