...
public class CfirStandaloneNormalAnalysisSourceModuleAnalysisApiAnnotationsOnDeclarationsWithMetaTestGenerated extends AbstractAnalysisApiAnnotationsOnDeclarationsWithMetaTest {
  @NotNull
  @Override
  ...
  public void testAllFilesPresentInMetaAnnotations() {
    CjTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("analysis/analysis-api/testData/annotations/metaAnnotations"), Pattern.compile("^(.+)\\.cj$"), null, true);
  }

  @Test
  @TestMetadata("metaAnnotation.cj")
  public void testMetaAnnotation() {
    run("metaAnnotation.cj");
  }
}
