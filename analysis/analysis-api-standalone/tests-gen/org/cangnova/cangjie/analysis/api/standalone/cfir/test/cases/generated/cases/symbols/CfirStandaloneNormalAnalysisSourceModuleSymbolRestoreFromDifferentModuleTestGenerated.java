...
public class CfirStandaloneNormalAnalysisSourceModuleSymbolRestoreFromDifferentModuleTestGenerated extends AbstractSymbolRestoreFromDifferentModuleTest {
  @NotNull
  @Override
  ...
  public void testAllFilesPresentInSymbolRestoreFromDifferentModule() {
    CjTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("analysis/analysis-api/testData/symbols/symbolRestoreFromDifferentModule"), Pattern.compile("^(.+)\\.cj$"), null, true);
  }

  @Test
  @TestMetadata("withDependency.cj")
  public void testWithDependency() {
    run("withDependency.cj");
  }
}
