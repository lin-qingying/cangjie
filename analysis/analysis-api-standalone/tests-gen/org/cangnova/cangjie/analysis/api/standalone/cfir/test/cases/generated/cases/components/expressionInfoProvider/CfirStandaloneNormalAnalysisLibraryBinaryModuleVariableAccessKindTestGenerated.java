...
public class CfirStandaloneNormalAnalysisLibraryBinaryModuleVariableAccessKindTestGenerated extends AbstractVariableAccessKindTest {
  @NotNull
  @Override
  ...
  public void testAllFilesPresentInReadWriteAccess() {
    CjTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("analysis/analysis-api/testData/components/expressionInfoProvider/readWriteAccess"), Pattern.compile("^(.+)\\.cj$"), null, true);
  }

  @Test
  @TestMetadata("propertyRead.cj")
  public void testPropertyRead() {
    run("propertyRead.cj");
  }

  @Test
  @TestMetadata("propertyWrite.cj")
  public void testPropertyWrite() {
    run("propertyWrite.cj");
  }

  @Test
  @TestMetadata("variableRead.cj")
  public void testVariableRead() {
    run("variableRead.cj");
  }

  @Test
  @TestMetadata("variableWrite.cj")
  public void testVariableWrite() {
    run("variableWrite.cj");
  }
}
