...
public class CfirStandaloneNormalAnalysisLibraryBinaryModuleExpectedExpressionTypeTestGenerated extends AbstractExpectedExpressionTypeTest {
  @NotNull
  @Override
  ...
  public void testAllFilesPresentInExpectedExpressionType() {
    CjTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("analysis/analysis-api/testData/components/expressionTypeProvider/expectedExpressionType"), Pattern.compile("^(.+)\\.cj$"), null, true);
  }

  @Test
  @TestMetadata("functionArgument.cj")
  public void testFunctionArgument() {
    run("functionArgument.cj");
  }

  @Test
  @TestMetadata("propertyInitializer.cj")
