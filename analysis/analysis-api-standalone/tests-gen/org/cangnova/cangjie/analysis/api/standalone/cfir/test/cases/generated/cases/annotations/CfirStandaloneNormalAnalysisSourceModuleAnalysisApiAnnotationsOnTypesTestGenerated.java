...
public class CfirStandaloneNormalAnalysisSourceModuleAnalysisApiAnnotationsOnTypesTestGenerated extends AbstractAnalysisApiAnnotationsOnTypesTest {
  @NotNull
  @Override
  ...
  public void testAllFilesPresentInAnnotationsOnTypes() {
    CjTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("analysis/analysis-api/testData/annotations/annotationsOnTypes"), Pattern.compile("^(.+)\\.cj$"), null, true);
  }

  @Test
  @TestMetadata("functionReturnWithoutTypeAnnotations.cj")
  public void testFunctionReturnWithoutTypeAnnotations() {
    run("functionReturnWithoutTypeAnnotations.cj");
  }
}
