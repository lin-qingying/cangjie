...
@TestMetadata("analysis/analysis-api/testData/components/substitutors/typeSubstitution")
@TestDataPath("$PROJECT_ROOT")
public class CfirStandaloneNormalAnalysisSourceModuleAnalysisApiSubstitutorsTestGenerated extends AbstractAnalysisApiSubstitutorsTest {
  @NotNull
  @Override
  ...
  private void run(String fileName) {
    runTest("analysis/analysis-api/testData/components/substitutors/typeSubstitution/" + fileName);
  }

  @Test
  public void testAllFilesPresentInTypeSubstitution() {
    CjTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("analysis/analysis-api/testData/components/substitutors/typeSubstitution"), Pattern.compile("^(.+)\\.cj$"), null, true);
  }

  @Test
  @TestMetadata("genericReturnType.cj")
