...
public class CfirStandaloneNormalAnalysisSourceModuleResolveSymbolTestGenerated extends AbstractResolveSymbolTest {
  @NotNull
  @Override
  ...
  public void testAllFilesPresentInSingleByPsi() {
    CjTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("analysis/analysis-api/testData/components/resolver/singleByPsi"), Pattern.compile("^(.+)\\.cj$"), null, true, "withTestCompilerPluginEnabled", "reference");
  }
