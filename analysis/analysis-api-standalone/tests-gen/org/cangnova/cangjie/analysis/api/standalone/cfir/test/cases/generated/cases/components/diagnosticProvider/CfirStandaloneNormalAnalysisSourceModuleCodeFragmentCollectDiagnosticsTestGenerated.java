...
@TestMetadata("analysis/analysis-api/testData/components/diagnosticProvider/codeFragmentDiagnostics")
@TestDataPath("$PROJECT_ROOT")
public class CfirStandaloneNormalAnalysisSourceModuleCodeFragmentCollectDiagnosticsTestGenerated extends AbstractCodeFragmentCollectDiagnosticsTest {
  @NotNull
  @Override
  ...
  private void run(String fileName) {
    runTest("analysis/analysis-api/testData/components/diagnosticProvider/codeFragmentDiagnostics/" + fileName);
  }

  @Test
  public void testAllFilesPresentInCodeFragmentDiagnostics() {
    CjTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("analysis/analysis-api/testData/components/diagnosticProvider/codeFragmentDiagnostics"), Pattern.compile("^(.+)\\.cj$"), null, true);
  }
