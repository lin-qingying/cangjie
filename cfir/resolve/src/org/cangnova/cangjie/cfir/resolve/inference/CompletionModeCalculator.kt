...
import org.cangnova.cangjie.cfir.resolve.calls.ConeFunctionTypeRelatedPostponedResolvedAtom
...
fun Candidate.computeCompletionMode(
    ...
    return when {
        ...
        postponedAtoms.any { it is ConeFunctionTypeRelatedPostponedResolvedAtom } ->
