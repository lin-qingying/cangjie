...
class CfirQuoteExpressionImpl @CfirImplementationDetail constructor(
    ...
    override val interpolations: MutableList<CfirExpression>,
) : CfirQuoteExpression() {
    ...
    override fun <D> transformAnnotations(transformer: CfirTransformer<D>, data: D): CfirQuoteExpressionImpl {
        annotations.transformInplace(transformer, data)
        return this
    }

    override fun <D> transformInterpolations(transformer: CfirTransformer<D>, data: D): CfirQuoteExpressionImpl {
        interpolations.transformInplace(transformer, data)
        return this
    }
