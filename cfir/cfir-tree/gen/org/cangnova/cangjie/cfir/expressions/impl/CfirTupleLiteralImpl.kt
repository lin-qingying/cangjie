...
class CfirTupleLiteralImpl @CfirImplementationDetail constructor(
    ...
    override fun <D> transformAnnotations(transformer: CfirTransformer<D>, data: D): CfirTupleLiteralImpl {
        annotations.transformInplace(transformer, data)
        return this
    }

    override fun <D> transformElements(transformer: CfirTransformer<D>, data: D): CfirTupleLiteralImpl {
