 ...
 */
abstract class CfirLoopExpression : CfirExpression(), CfirTargetElement {
    ...
    abstract override fun <D> transformAnnotations(transformer: CfirTransformer<D>, data: D): CfirLoopExpression
