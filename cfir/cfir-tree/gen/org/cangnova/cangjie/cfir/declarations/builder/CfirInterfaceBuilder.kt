...
inline fun buildInterface(init: CfirInterfaceBuilder.() -> Unit): CfirInterface {
    contract {
        callsInPlace(init, InvocationKind.EXACTLY_ONCE)
    }
    return CfirInterfaceBuilder().apply(init).build()
}

@OptIn(ExperimentalContracts::class)
inline fun buildInterfaceCopy(original: CfirInterface, init: CfirInterfaceBuilder.() -> Unit): CfirInterface {
    contract {
        callsInPlace(init, InvocationKind.EXACTLY_ONCE)
    }
