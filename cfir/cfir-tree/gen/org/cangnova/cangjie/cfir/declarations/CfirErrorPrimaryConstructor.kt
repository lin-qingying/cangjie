...
/**
 * Generated from: [org.cangnova.cangjie.cfir.tree.generator.CfirTree.errorPrimaryConstructor]
 */
abstract class CfirErrorPrimaryConstructor : CfirConstructor(), CfirDiagnosticHolder {
    ...
    override fun <R, D> accept(visitor: CfirVisitor<R, D>, data: D): R =
        visitor.visitErrorPrimaryConstructor(this, data)
    ...
    abstract override fun <D> transformAnnotations(transformer: CfirTransformer<D>, data: D): CfirErrorPrimaryConstructor

    abstract override fun <D> transformStatus(transformer: CfirTransformer<D>, data: D): CfirErrorPrimaryConstructor

    abstract override fun <D> transformTypeParameters(transformer: CfirTransformer<D>, data: D): CfirErrorPrimaryConstructor

    abstract override fun <D> transformReturnTypeRef(transformer: CfirTransformer<D>, data: D): CfirErrorPrimaryConstructor

    abstract override fun <D> transformValueParameters(transformer: CfirTransformer<D>, data: D): CfirErrorPrimaryConstructor

    abstract override fun <D> transformBody(transformer: CfirTransformer<D>, data: D): CfirErrorPrimaryConstructor
}
