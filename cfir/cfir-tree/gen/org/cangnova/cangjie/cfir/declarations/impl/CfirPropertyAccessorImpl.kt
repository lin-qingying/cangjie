...
class CfirPropertyAccessorImpl @CfirImplementationDetail constructor(
    ...
    override fun <D> transformChildren(transformer: CfirTransformer<D>, data: D): CfirPropertyAccessorImpl {
    ...
    override fun <D> transformAnnotations(transformer: CfirTransformer<D>, data: D): CfirPropertyAccessorImpl {
        annotations.transformInplace(transformer, data)
        return this
    }

    override fun <D> transformStatus(transformer: CfirTransformer<D>, data: D): CfirPropertyAccessorImpl {
        return this
    }

    override fun <D> transformTypeParameters(transformer: CfirTransformer<D>, data: D): CfirPropertyAccessorImpl {
        typeParameters.transformInplace(transformer, data)
        return this
    }

    override fun <D> transformReturnTypeRef(transformer: CfirTransformer<D>, data: D): CfirPropertyAccessorImpl {
        returnTypeRef = returnTypeRef.transform(transformer, data)
        return this
    }

    override fun <D> transformValueParameters(transformer: CfirTransformer<D>, data: D): CfirPropertyAccessorImpl {
        valueParameters.transformInplace(transformer, data)
        return this
    }

    override fun <D> transformBody(transformer: CfirTransformer<D>, data: D): CfirPropertyAccessorImpl {
