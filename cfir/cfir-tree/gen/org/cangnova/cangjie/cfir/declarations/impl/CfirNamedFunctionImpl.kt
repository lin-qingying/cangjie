...
class CfirNamedFunctionImpl @CfirImplementationDetail constructor(
    ...
    override fun <D> transformAnnotations(transformer: CfirTransformer<D>, data: D): CfirNamedFunction
     {
        this.annotations = annotations.map { it.transform<org.cangnova.cangjie.cfir.CfirElement, D>(transformer, data) as CfirAnnotation }
        return this
    }

    override fun <D> transformStatus(transformer: CfirTransformer<D>, data: D): CfirNamedFunction
     {
        this.status = status.transform<org.cangnova.cangjie.cfir.CfirElement, D>(transformer, data) as CfirDeclarationStatus
        return this
    }

    override fun <D> transformTypeParameters(transformer: CfirTransformer<D>, data: D): CfirNamedFunction
     {
    ...
    override fun <D> transformReturnTypeRef(transformer: CfirTransformer<D>, data: D): CfirNamedFunction
     {
        this.returnTypeRef = returnTypeRef.transform<org.cangnova.cangjie.cfir.CfirElement, D>(transformer, data) as CfirTypeRef
        return this
    }

    override fun <D> transformValueParameters(transformer: CfirTransformer<D>, data: D): CfirNamedFunction
     {
    ...
    override fun <D> transformBody(transformer: CfirTransformer<D>, data: D): CfirNamedFunction
     {
