...
class CfirPrimaryConstructor @CfirImplementationDetail constructor(
    ...
    override fun <D> transformChildren(transformer: CfirTransformer<D>, data: D): CfirPrimaryConstructor {
    ...
    override fun <D> transformAnnotations(transformer: CfirTransformer<D>, data: D): CfirPrimaryConstructor {
        annotations.transformInplace(transformer, data)
        return this
    }

    override fun <D> transformStatus(transformer: CfirTransformer<D>, data: D): CfirPrimaryConstructor {
        return this
    }

    override fun <D> transformTypeParameters(transformer: CfirTransformer<D>, data: D): CfirPrimaryConstructor {
        typeParameters.transformInplace(transformer, data)
        return this
    }

    override fun <D> transformReturnTypeRef(transformer: CfirTransformer<D>, data: D): CfirPrimaryConstructor {
        returnTypeRef = returnTypeRef.transform(transformer, data)
        return this
    }

    override fun <D> transformValueParameters(transformer: CfirTransformer<D>, data: D): CfirPrimaryConstructor {
        valueParameters.transformInplace(transformer, data)
        return this
    }

    override fun <D> transformBody(transformer: CfirTransformer<D>, data: D): CfirPrimaryConstructor {
