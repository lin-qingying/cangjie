...
abstract class CfirStruct : CfirClassLikeDeclaration(), CfirControlFlowGraphOwner {
    ...
    override abstract fun <D> transformAnnotations(transformer: CfirTransformer<D>, data: D): CfirStruct


    override abstract fun <D> transformStatus(transformer: CfirTransformer<D>, data: D): CfirStruct


    override abstract fun <D> transformTypeParameters(transformer: CfirTransformer<D>, data: D): CfirStruct


    override abstract fun <D> transformSuperTypeRefs(transformer: CfirTransformer<D>, data: D): CfirStruct


    override abstract fun <D> transformDeclarations(transformer: CfirTransformer<D>, data: D): CfirStruct
