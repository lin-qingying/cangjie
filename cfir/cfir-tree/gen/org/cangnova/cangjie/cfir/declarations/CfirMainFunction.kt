...
abstract class CfirMainFunction : CfirFunction() {
    ...
    override abstract fun <D> transformStatus(transformer: CfirTransformer<D>, data: D): CfirMainFunction


    override abstract fun <D> transformTypeParameters(transformer: CfirTransformer<D>, data: D): CfirMainFunction


    override abstract fun <D> transformReturnTypeRef(transformer: CfirTransformer<D>, data: D): CfirMainFunction


    override abstract fun <D> transformValueParameters(transformer: CfirTransformer<D>, data: D): CfirMainFunction


    override abstract fun <D> transformBody(transformer: CfirTransformer<D>, data: D): CfirMainFunction
