...
abstract class CfirMacroDeclaration : CfirFunction() {
    ...
    abstract override fun <D> transformAnnotations(transformer: CfirTransformer<D>, data: D): CfirMacroDeclaration

    abstract override fun <D> transformStatus(transformer: CfirTransformer<D>, data: D): CfirMacroDeclaration

    abstract override fun <D> transformTypeParameters(transformer: CfirTransformer<D>, data: D): CfirMacroDeclaration

    abstract override fun <D> transformReturnTypeRef(transformer: CfirTransformer<D>, data: D): CfirMacroDeclaration

    abstract override fun <D> transformValueParameters(transformer: CfirTransformer<D>, data: D): CfirMacroDeclaration

    abstract override fun <D> transformBody(transformer: CfirTransformer<D>, data: D): CfirMacroDeclaration
}
