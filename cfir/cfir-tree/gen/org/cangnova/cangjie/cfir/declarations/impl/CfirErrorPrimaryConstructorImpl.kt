...
internal class CfirErrorPrimaryConstructorImpl(
    ...
    override fun <D> transformChildren(transformer: CfirTransformer<D>, data: D): CfirErrorPrimaryConstructorImpl {
    ...
    override fun <D> transformAnnotations(transformer: CfirTransformer<D>, data: D): CfirErrorPrimaryConstructorImpl {
        annotations.transformInplace(transformer, data)
        return this
    }

    override fun <D> transformStatus(transformer: CfirTransformer<D>, data: D): CfirErrorPrimaryConstructorImpl {
        return this
    }

    override fun <D> transformTypeParameters(transformer: CfirTransformer<D>, data: D): CfirErrorPrimaryConstructorImpl {
        typeParameters.transformInplace(transformer, data)
        return this
    }

    override fun <D> transformReturnTypeRef(transformer: CfirTransformer<D>, data: D): CfirErrorPrimaryConstructorImpl {
        returnTypeRef = returnTypeRef.transform(transformer, data)
        return this
    }

    override fun <D> transformValueParameters(transformer: CfirTransformer<D>, data: D): CfirErrorPrimaryConstructorImpl {
        valueParameters.transformInplace(transformer, data)
        return this
    }

    override fun <D> transformBody(transformer: CfirTransformer<D>, data: D): CfirErrorPrimaryConstructorImpl {
