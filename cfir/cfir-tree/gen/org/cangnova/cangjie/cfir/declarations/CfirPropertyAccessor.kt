...
/**
 * Generated from: [org.cangnova.cangjie.cfir.tree.generator.CfirTree.propertyAccessor]
 */
abstract class CfirPropertyAccessor : CfirFunction() {
    ...
    abstract override val symbol: CfirPropertyAccessorSymbol
    abstract val propertySymbol: CfirPropertySymbol
    ...
    abstract override fun <D> transformAnnotations(transformer: CfirTransformer<D>, data: D): CfirPropertyAccessor

    abstract override fun <D> transformStatus(transformer: CfirTransformer<D>, data: D): CfirPropertyAccessor

    abstract override fun <D> transformTypeParameters(transformer: CfirTransformer<D>, data: D): CfirPropertyAccessor

    abstract override fun <D> transformReturnTypeRef(transformer: CfirTransformer<D>, data: D): CfirPropertyAccessor

    abstract override fun <D> transformValueParameters(transformer: CfirTransformer<D>, data: D): CfirPropertyAccessor

    abstract override fun <D> transformBody(transformer: CfirTransformer<D>, data: D): CfirPropertyAccessor
}
