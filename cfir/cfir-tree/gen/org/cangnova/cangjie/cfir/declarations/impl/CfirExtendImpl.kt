...
class CfirExtendImpl @CfirImplementationDetail constructor(
    ...
    override fun <D> transformAnnotations(transformer: CfirTransformer<D>, data: D): CfirExtendImpl {
        annotations.transformInplace(transformer, data)
        return this
    }

    override fun <D> transformStatus(transformer: CfirTransformer<D>, data: D): CfirExtendImpl {
        return this
    }

    override fun <D> transformTypeParameters(transformer: CfirTransformer<D>, data: D): CfirExtendImpl {
        typeParameters.transformInplace(transformer, data)
        return this
    }

    override fun <D> transformExtendedTypeRef(transformer: CfirTransformer<D>, data: D): CfirExtendImpl {
        extendedTypeRef = extendedTypeRef.transform(transformer, data)
        return this
    }

    override fun <D> transformSuperTypeRefs(transformer: CfirTransformer<D>, data: D): CfirExtendImpl {
        superTypeRefs.transformInplace(transformer, data)
        return this
    }

    override fun <D> transformDeclarations(transformer: CfirTransformer<D>, data: D): CfirExtendImpl {
