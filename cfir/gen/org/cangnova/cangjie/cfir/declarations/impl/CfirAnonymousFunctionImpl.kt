...
class CfirAnonymousFunctionImpl @CfirImplementationDetail constructor(
    ...
    override fun replaceMatchingParameterFunctionType(newMatchingParameterFunctionType: ConeCangJieType?)
     {
        this.matchingParameterFunctionType = newMatchingParameterFunctionType
    }

    override fun <D> transformAnnotations(transformer: CfirTransformer<D>, data: D): CfirAnonymousFunction
     {
        this.annotations = annotations.map { it.transform<org.cangnova.cangjie.cfir.CfirElement, D>(transformer, data) as CfirAnnotation }
        return this
    }

    override fun <D> transformStatus(transformer: CfirTransformer<D>, data: D): CfirAnonymousFunction
     {
        this.status = status.transform<org.cangnova.cangjie.cfir.CfirElement, D>(transformer, data) as CfirDeclarationStatus
        return this
    }

    override fun <D> transformTypeParameters(transformer: CfirTransformer<D>, data: D): CfirAnonymousFunction
     {
    ...
    override fun <D> transformReturnTypeRef(transformer: CfirTransformer<D>, data: D): CfirAnonymousFunction
     {
        this.returnTypeRef = returnTypeRef.transform<org.cangnova.cangjie.cfir.CfirElement, D>(transformer, data) as CfirTypeRef
        return this
    }

    override fun <D> transformValueParameters(transformer: CfirTransformer<D>, data: D): CfirAnonymousFunction
     {
    ...
    override fun <D> transformBody(transformer: CfirTransformer<D>, data: D): CfirAnonymousFunction
     {
        this.body = body?.transform<org.cangnova.cangjie.cfir.CfirElement, D>(transformer, data) as CfirBlock?
        return this
    }

    override fun <D> transformChildren(transformer: CfirTransformer<D>, data: D): CfirAnonymousFunctionImpl {
        ...
        typeRef.transform<org.cangnova.cangjie.cfir.CfirElement, D>(transformer, data)
        return this
    }
}
