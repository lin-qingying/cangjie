...
class ExpressionCheckersDiagnosticComponent(
    ...
    override fun visitIncrementDecrementExpression(incrementDecrementExpression: CfirIncrementDecrementExpression, data: CheckerContext) {
        checkers.allIncrementDecrementExpressionCheckers.check(incrementDecrementExpression, data)
    }
    ...
    override fun visitWrappedExpression(wrappedExpression: CfirWrappedExpression, data: CheckerContext) {
    ...
    override fun visitOptionalChainExpression(optionalChainExpression: CfirOptionalChainExpression, data: CheckerContext) {
    ...
    override fun visitLetPatternExpression(letPatternExpression: CfirLetPatternExpression, data: CheckerContext) {
        checkers.allBasicExpressionCheckers.check(letPatternExpression, data)
    }
