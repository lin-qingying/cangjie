...
object CfirErrors : CjDiagnosticsContainer() {
    ...
    // Redeclaration
    val CONFLICTING_OVERLOADS: CjDiagnosticFactory1<Collection<String>> = CjDiagnosticFactory1("CFIR_CONFLICTING_OVERLOADS", Severity.ERROR, SourceElementPositioningStrategies.ACTUAL_DECLARATION_NAME, CjNamedDeclaration::class, getRendererFactory())
    val REDECLARATION: CjDiagnosticFactory1<Collection<String>> = CjDiagnosticFactory1("CFIR_REDECLARATION", Severity.ERROR, SourceElementPositioningStrategies.ACTUAL_DECLARATION_NAME, PsiElement::class, getRendererFactory())
    ...
    val INHERITANCE_CYCLE: CjDiagnosticFactory0 = CjDiagnosticFactory0("CFIR_INHERITANCE_CYCLE", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val SUPER_TYPES_DUPLICATE: CjDiagnosticFactory1<Name> = CjDiagnosticFactory1("CFIR_SUPER_TYPES_DUPLICATE", Severity.ERROR, SourceElementPositioningStrategies.ACTUAL_DECLARATION_NAME, PsiElement::class, getRendererFactory())
    ...
    val CLASS_INHERIT_NON_CLASS_NOR_INTERFACE: CjDiagnosticFactory1<Name> = CjDiagnosticFactory1("CFIR_CLASS_INHERIT_NON_CLASS_NOR_INTERFACE", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, CjTypeReference::class, getRendererFactory())
    ...
    val ILLEGAL_MULTI_INHERITANCE: CjDiagnosticFactory1<Name> = CjDiagnosticFactory1("CFIR_ILLEGAL_MULTI_INHERITANCE", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, CjTypeReference::class, getRendererFactory())
    val SUPERCLASS_MUST_BE_PLACED_AT_FIRST: CjDiagnosticFactory1<Name> = CjDiagnosticFactory1("CFIR_SUPERCLASS_MUST_BE_PLACED_AT_FIRST", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, CjTypeReference::class, getRendererFactory())
    val NON_INHERITABLE_SUPER_CLASS: CjDiagnosticFactory1<Name> = CjDiagnosticFactory1("CFIR_NON_INHERITABLE_SUPER_CLASS", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, CjTypeReference::class, getRendererFactory())
    ...
    val EXTEND_GENERIC_USAGE: CjDiagnosticFactory1<String> = CjDiagnosticFactory1("CFIR_EXTEND_GENERIC_USAGE", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, CjTypeReference::class, getRendererFactory())
    ...
    // DeclarationStatus
    val STATIC_CANNOT_BE_OPEN_ABSTRACT_OVERRIDE: CjDiagnosticFactory1<Name?> = CjDiagnosticFactory1("CFIR_STATIC_CANNOT_BE_OPEN_ABSTRACT_OVERRIDE", Severity.ERROR, SourceElementPositioningStrategies.ACTUAL_DECLARATION_NAME, CjNamedDeclaration::class, getRendererFactory())
    val MISSING_FUNC_BODY: CjDiagnosticFactory2<String, Name> = CjDiagnosticFactory2("CFIR_MISSING_FUNC_BODY", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val MUT_ONLY_ON_FUNCTION: CjDiagnosticFactory1<Name?> = CjDiagnosticFactory1("CFIR_MUT_ONLY_ON_FUNCTION", Severity.ERROR, SourceElementPositioningStrategies.ACTUAL_DECLARATION_NAME, CjNamedDeclaration::class, getRendererFactory())
    ...
    val OPERATOR_OVERLOAD_BUILT_IN_UNARY_OPERATOR: CjDiagnosticFactory2<String, String> = CjDiagnosticFactory2("CFIR_OPERATOR_OVERLOAD_BUILT_IN_UNARY_OPERATOR", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val OPERATOR_OVERLOAD_BUILT_IN_BINARY_OPERATOR: CjDiagnosticFactory3<String, String, String> = CjDiagnosticFactory3("CFIR_OPERATOR_OVERLOAD_BUILT_IN_BINARY_OPERATOR", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    ...
    val IGNORE_OPEN: CjDiagnosticFactory0 = CjDiagnosticFactory0("CFIR_IGNORE_OPEN", Severity.WARNING, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    ...
    val MULTIPLE_PRIMARY_CONSTRUCTORS: CjDiagnosticFactory0 = CjDiagnosticFactory0("CFIR_MULTIPLE_PRIMARY_CONSTRUCTORS", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    ...
    val THIS_OR_SUPER_NOT_ALLOWED_TO_INITIALIZE_NON_STATIC_MEMBER: CjDiagnosticFactory1<String> = CjDiagnosticFactory1("CFIR_THIS_OR_SUPER_NOT_ALLOWED_TO_INITIALIZE_NON_STATIC_MEMBER", Severity.ERROR, SourceElementPositioningStrategies.REFERENCED_NAME_BY_QUALIFIED, PsiElement::class, getRendererFactory())
    val THIS_OR_SUPER_NOT_ALLOWED_TO_INITIALIZE_STATIC_MEMBER: CjDiagnosticFactory1<String> = CjDiagnosticFactory1("CFIR_THIS_OR_SUPER_NOT_ALLOWED_TO_INITIALIZE_STATIC_MEMBER", Severity.ERROR, SourceElementPositioningStrategies.REFERENCED_NAME_BY_QUALIFIED, PsiElement::class, getRendererFactory())
    val THIS_SUPER_USE_ERROR_OUTSIDE_CLASS: CjDiagnosticFactory1<String> = CjDiagnosticFactory1("CFIR_THIS_SUPER_USE_ERROR_OUTSIDE_CLASS", Severity.ERROR, SourceElementPositioningStrategies.REFERENCED_NAME_BY_QUALIFIED, PsiElement::class, getRendererFactory())
    val INVALID_THIS_CALL_OUTSIDE_CTOR: CjDiagnosticFactory1<String> = CjDiagnosticFactory1("CFIR_INVALID_THIS_CALL_OUTSIDE_CTOR", Severity.ERROR, SourceElementPositioningStrategies.REFERENCED_NAME_BY_QUALIFIED, PsiElement::class, getRendererFactory())
    val ILLEGAL_SUPER_ALONE: CjDiagnosticFactory0 = CjDiagnosticFactory0("CFIR_ILLEGAL_SUPER_ALONE", Severity.ERROR, SourceElementPositioningStrategies.REFERENCED_NAME_BY_QUALIFIED, PsiElement::class, getRendererFactory())
    val ILLEGAL_THIS_OUTSIDE_STRUCT_CONSTRUCTOR: CjDiagnosticFactory0 = CjDiagnosticFactory0("CFIR_ILLEGAL_THIS_OUTSIDE_STRUCT_CONSTRUCTOR", Severity.ERROR, SourceElementPositioningStrategies.REFERENCED_NAME_BY_QUALIFIED, PsiElement::class, getRendererFactory())
    val ILLEGAL_PLACE_OF_CALLING_THIS_OR_SUPER: CjDiagnosticFactory1<String> = CjDiagnosticFactory1("CFIR_ILLEGAL_PLACE_OF_CALLING_THIS_OR_SUPER", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val ILLEGAL_PLACE_OF_CALLING_THIS_PRIMARY_CONSTRUCTOR: CjDiagnosticFactory0 = CjDiagnosticFactory0("CFIR_ILLEGAL_PLACE_OF_CALLING_THIS_PRIMARY_CONSTRUCTOR", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val ASSIGNMENT_OF_MEMBER_VARIABLE_CANNOT_USE_THIS_OR_SUPER: CjDiagnosticFactory2<String, String> = CjDiagnosticFactory2("CFIR_ASSIGNMENT_OF_MEMBER_VARIABLE_CANNOT_USE_THIS_OR_SUPER", Severity.ERROR, SourceElementPositioningStrategies.REFERENCED_NAME_BY_QUALIFIED, PsiElement::class, getRendererFactory())
    val ILLEGAL_MEMBER_USED_IN_OPEN_CONSTRUCTOR: CjDiagnosticFactory3<String, String, Name> = CjDiagnosticFactory3("CFIR_ILLEGAL_MEMBER_USED_IN_OPEN_CONSTRUCTOR", Severity.ERROR, SourceElementPositioningStrategies.REFERENCED_NAME_BY_QUALIFIED, PsiElement::class, getRendererFactory())
    val ABSTRACT_METHOD_CANNOT_BE_ACCESSED_DIRECTLY: CjDiagnosticFactory0 = CjDiagnosticFactory0("CFIR_ABSTRACT_METHOD_CANNOT_BE_ACCESSED_DIRECTLY", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val THIS_AS_EXPRESSION_IN_FUNC: CjDiagnosticFactory1<String> = CjDiagnosticFactory1("CFIR_THIS_AS_EXPRESSION_IN_FUNC", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val STATIC_MEMBERS_CANNOT_CALL_MEMBERS: CjDiagnosticFactory0 = CjDiagnosticFactory0("CFIR_STATIC_MEMBERS_CANNOT_CALL_MEMBERS", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val ILLEGAL_ACCESS_NON_STATIC_MEMBER: CjDiagnosticFactory1<Name> = CjDiagnosticFactory1("CFIR_ILLEGAL_ACCESS_NON_STATIC_MEMBER", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val STATIC_FUNCTION_CANNOT_ACCESS_NON_STATIC_MEMBER: CjDiagnosticFactory1<Name> = CjDiagnosticFactory1("CFIR_STATIC_FUNCTION_CANNOT_ACCESS_NON_STATIC_MEMBER", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val STATIC_LAMBDA_CANNOT_ACCESS_NON_STATIC: CjDiagnosticFactory1<Name> = CjDiagnosticFactory1("CFIR_STATIC_LAMBDA_CANNOT_ACCESS_NON_STATIC", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val STATIC_VARIABLE_CANNOT_ACCESS_NON_STATIC_MEMBER: CjDiagnosticFactory1<Name> = CjDiagnosticFactory1("CFIR_STATIC_VARIABLE_CANNOT_ACCESS_NON_STATIC_MEMBER", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val OBJECT_CANNOT_ACCESS_STATIC_MEMBER: CjDiagnosticFactory1<Name> = CjDiagnosticFactory1("CFIR_OBJECT_CANNOT_ACCESS_STATIC_MEMBER", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    ...
    val NO_NON_PARAM_CONSTRUCTOR_IN_SUPER_CLASS: CjDiagnosticFactory0 = CjDiagnosticFactory0("CFIR_NO_NON_PARAM_CONSTRUCTOR_IN_SUPER_CLASS", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    ...
    // Initialization
    val ILLEGAL_USAGE_OF_MEMBER: CjDiagnosticFactory1<Name> = CjDiagnosticFactory1("CFIR_ILLEGAL_USAGE_OF_MEMBER", Severity.ERROR, SourceElementPositioningStrategies.REFERENCED_NAME_BY_QUALIFIED, PsiElement::class, getRendererFactory())
    val ILLEGAL_USAGE_OF_SUPER_MEMBER: CjDiagnosticFactory1<Name> = CjDiagnosticFactory1("CFIR_ILLEGAL_USAGE_OF_SUPER_MEMBER", Severity.ERROR, SourceElementPositioningStrategies.REFERENCED_NAME_BY_QUALIFIED, PsiElement::class, getRendererFactory())
    ...
    val IMMUTABLE_FUNCTION_CANNOT_ACCESS_MUTABLE_FUNCTION: CjDiagnosticFactory2<Name, Name> = CjDiagnosticFactory2("CFIR_IMMUTABLE_FUNCTION_CANNOT_ACCESS_MUTABLE_FUNCTION", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val ILLEGAL_CAPTURE_THIS: CjDiagnosticFactory1<String> = CjDiagnosticFactory1("CFIR_ILLEGAL_CAPTURE_THIS", Severity.ERROR, SourceElementPositioningStrategies.REFERENCED_NAME_BY_QUALIFIED, PsiElement::class, getRendererFactory())
    val CAPTURE_THIS_OR_INSTANCE_FIELD_IN_FUNC: CjDiagnosticFactory2<Name, String> = CjDiagnosticFactory2("CFIR_CAPTURE_THIS_OR_INSTANCE_FIELD_IN_FUNC", Severity.ERROR, SourceElementPositioningStrategies.REFERENCED_NAME_BY_QUALIFIED, PsiElement::class, getRendererFactory())
    ...
    val CFUNC_CANNOT_CAPTURE_THIS: CjDiagnosticFactory1<String> = CjDiagnosticFactory1("CFIR_CFUNC_CANNOT_CAPTURE_THIS", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val FUNC_CAPTURE_VAR_NOT_CTYPE: CjDiagnosticFactory0 = CjDiagnosticFactory0("CFIR_FUNC_CAPTURE_VAR_NOT_CTYPE", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val CFFI_CANNOT_HAVE_TYPE_PARAM: CjDiagnosticFactory1<String> = CjDiagnosticFactory1("CFIR_CFFI_CANNOT_HAVE_TYPE_PARAM", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val CFUNC_TYPE: CjDiagnosticFactory0 = CjDiagnosticFactory0("CFIR_CFUNC_TYPE", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, CjTypeReference::class, getRendererFactory())
    val CFUNC_TOO_MANY_ARGUMENTS: CjDiagnosticFactory0 = CjDiagnosticFactory0("CFIR_CFUNC_TOO_MANY_ARGUMENTS", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val CFUNC_CTOR_MUST_BE_CPOINTER: CjDiagnosticFactory0 = CjDiagnosticFactory0("CFIR_CFUNC_CTOR_MUST_BE_CPOINTER", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val POINTER_SINGLE_ELEMENT_TYPE_ERROR: CjDiagnosticFactory0 = CjDiagnosticFactory0("CFIR_POINTER_SINGLE_ELEMENT_TYPE_ERROR", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val POINTER_TOO_MUCH_ARGUMENT: CjDiagnosticFactory0 = CjDiagnosticFactory0("CFIR_POINTER_TOO_MUCH_ARGUMENT", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    ...
    val UNSAFE_FUNCTION_INVOKE_FAILED: CjDiagnosticFactory0 = CjDiagnosticFactory0("CFIR_UNSAFE_FUNCTION_INVOKE_FAILED", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    ...
    val COMMAND_INCOMPATIBLE_TYPE: CjDiagnosticFactory1<ConeCangJieType> = CjDiagnosticFactory1("CFIR_COMMAND_INCOMPATIBLE_TYPE", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, CjExpression::class, getRendererFactory())
    val COMMAND_HANDLE_TYPE_ERROR: CjDiagnosticFactory1<ConeCangJieType> = CjDiagnosticFactory1("CFIR_COMMAND_HANDLE_TYPE_ERROR", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, CjTypeReference::class, getRendererFactory())
    ...
    val MISMATCHING_HANDLE_BLOCK: CjDiagnosticFactory2<ConeCangJieType, ConeCangJieType> = CjDiagnosticFactory2("CFIR_MISMATCHING_HANDLE_BLOCK", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, CjBlockExpression::class, getRendererFactory())
    ...
    val MULTIPLE_CLASS_UPPER_BOUNDS: CjDiagnosticFactory0 = CjDiagnosticFactory0("CFIR_MULTIPLE_CLASS_UPPER_BOUNDS", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, CjElement::class, getRendererFactory())
    ...
    val ARRAY_LITERAL_TYPE_CANNOT_BE_INFERRED: CjDiagnosticFactory0 = CjDiagnosticFactory0("CFIR_ARRAY_LITERAL_TYPE_CANNOT_BE_INFERRED", Severity.ERROR, SourceElementPositioningStrategies.ARRAY_LITERAL_LEFT_BRACKET, PsiElement::class, getRendererFactory())
    val INCONSISTENT_ARRAY_LITERAL_ELEMENT_TYPE: CjDiagnosticFactory0 = CjDiagnosticFactory0("CFIR_INCONSISTENT_ARRAY_LITERAL_ELEMENT_TYPE", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    ...
    val CANNOT_CONVERT_LITERAL: CjDiagnosticFactory2<String, ConeCangJieType> = CjDiagnosticFactory2("CFIR_CANNOT_CONVERT_LITERAL", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val RETURN_TYPE_INCOMPATIBLE: CjDiagnosticFactory1<Name> = CjDiagnosticFactory1("CFIR_RETURN_TYPE_INCOMPATIBLE", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val RETURN_TYPE_INVARIANCE: CjDiagnosticFactory2<Name, ConeCangJieType> = CjDiagnosticFactory2("CFIR_RETURN_TYPE_INVARIANCE", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val PROPERTY_OVERRIDE_IMPLEMENT_TYPE_DIFF: CjDiagnosticFactory3<ConeCangJieType, ConeCangJieType, Name> = CjDiagnosticFactory3("CFIR_PROPERTY_OVERRIDE_IMPLEMENT_TYPE_DIFF", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val MISSING_ENTRY: CjDiagnosticFactory0 = CjDiagnosticFactory0("CFIR_MISSING_ENTRY", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val UNEXPECTED_PARAM_FOR_ENTRY: CjDiagnosticFactory0 = CjDiagnosticFactory0("CFIR_UNEXPECTED_PARAM_FOR_ENTRY", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val UNEXPECTED_RETURN_TYPE_FOR_ENTRY: CjDiagnosticFactory0 = CjDiagnosticFactory0("CFIR_UNEXPECTED_RETURN_TYPE_FOR_ENTRY", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    ...
    // Unresolved
    val UNDECLARED_TYPE_NAME: CjDiagnosticFactory1<String> = CjDiagnosticFactory1("CFIR_UNDECLARED_TYPE_NAME", Severity.ERROR, SourceElementPositioningStrategies.REFERENCED_NAME_BY_QUALIFIED, PsiElement::class, getRendererFactory())
    ...
    val AMBIGUOUS_FUNCTION_REFERENCE: CjDiagnosticFactory1<Name> = CjDiagnosticFactory1("CFIR_AMBIGUOUS_FUNCTION_REFERENCE", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    ...
    val FUNC_CAPTURE_VAR_CANNOT_ASSIGN: CjDiagnosticFactory3<String, String, String> = CjDiagnosticFactory3("CFIR_FUNC_CAPTURE_VAR_CANNOT_ASSIGN", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val FUNC_CAPTURE_VAR_CANNOT_RETURN: CjDiagnosticFactory3<String, String, String> = CjDiagnosticFactory3("CFIR_FUNC_CAPTURE_VAR_CANNOT_RETURN", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val FUNC_CAPTURE_VAR_CANNOT_PARAM: CjDiagnosticFactory3<String, String, String> = CjDiagnosticFactory3("CFIR_FUNC_CAPTURE_VAR_CANNOT_PARAM", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val FUNC_CAPTURE_VAR_CANNOT_EXPR: CjDiagnosticFactory3<String, String, String> = CjDiagnosticFactory3("CFIR_FUNC_CAPTURE_VAR_CANNOT_EXPR", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    ...
    val CAPTURE_HAS_SHADOW_VARIABLE: CjDiagnosticFactory1<Name> = CjDiagnosticFactory1("CFIR_CAPTURE_HAS_SHADOW_VARIABLE", Severity.WARNING, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    ...
    val CANNOT_INSTANTIATED_BY_INCOMPLETE_TYPE: CjDiagnosticFactory2<Name, ConeCangJieType> = CjDiagnosticFactory2("CFIR_CANNOT_INSTANTIATED_BY_INCOMPLETE_TYPE", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    ...
    val STATIC_AND_NON_STATIC_MEMBER_CANNOT_HAVE_SAME_NAME: CjDiagnosticFactory4<String, Name, String, String> = CjDiagnosticFactory4("CFIR_STATIC_AND_NON_STATIC_MEMBER_CANNOT_HAVE_SAME_NAME", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val MEMBER_VARIABLE_CAN_NOT_SHADOW: CjDiagnosticFactory1<Name> = CjDiagnosticFactory1("CFIR_MEMBER_VARIABLE_CAN_NOT_SHADOW", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val CANNOT_OVERRIDE: CjDiagnosticFactory2<String, Name> = CjDiagnosticFactory2("CFIR_CANNOT_OVERRIDE", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val INVALID_OVERRIDE_MEMBER_IN_CLASS: CjDiagnosticFactory2<String, Name> = CjDiagnosticFactory2("CFIR_INVALID_OVERRIDE_MEMBER_IN_CLASS", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val NEED_MEMBER_IMPLEMENTATION: CjDiagnosticFactory1<String> = CjDiagnosticFactory1("CFIR_NEED_MEMBER_IMPLEMENTATION", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val INTERFACE_MEMBER_MUST_BE_IMPLEMENTED: CjDiagnosticFactory3<String, Name, String> = CjDiagnosticFactory3("CFIR_INTERFACE_MEMBER_MUST_BE_IMPLEMENTED", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val INCOMPATIBLE_MUT_MODIFIER_BETWEEN_STRUCT_AND_INTERFACE: CjDiagnosticFactory0 = CjDiagnosticFactory0("CFIR_INCOMPATIBLE_MUT_MODIFIER_BETWEEN_STRUCT_AND_INTERFACE", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    ...
    val CANNOT_HAVE_PARAMETER: CjDiagnosticFactory1<String> = CjDiagnosticFactory1("CFIR_CANNOT_HAVE_PARAMETER", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    ...
    val EXTEND_A_JAVA_TYPE: CjDiagnosticFactory0 = CjDiagnosticFactory0("CFIR_EXTEND_A_JAVA_TYPE", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, CjTypeReference::class, getRendererFactory())
    ...
    val UNUSED_VARIABLE: CjDiagnosticFactory0 = CjDiagnosticFactory0("CFIR_UNUSED_VARIABLE", Severity.WARNING, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val UNUSED_FUNCTION: CjDiagnosticFactory0 = CjDiagnosticFactory0("CFIR_UNUSED_FUNCTION", Severity.WARNING, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val TYPEALIAS_UNUSED_TYPE_PARAMETERS: CjDiagnosticFactory1<String> = CjDiagnosticFactory1("CFIR_TYPEALIAS_UNUSED_TYPE_PARAMETERS", Severity.WARNING, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val TYPEALIAS_CYCLE: CjDiagnosticFactory1<String> = CjDiagnosticFactory1("CFIR_TYPEALIAS_CYCLE", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    ...
    val MACRO_UNDEFINED_PACKAGE: CjDiagnosticFactory2<String, String> = CjDiagnosticFactory2("CFIR_MACRO_UNDEFINED_PACKAGE", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val MACRO_UNDECLARED_IDENTIFIER: CjDiagnosticFactory2<Name, String> = CjDiagnosticFactory2("CFIR_MACRO_UNDECLARED_IDENTIFIER", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val MACRO_EXPECT_MACRO_DEFINITION: CjDiagnosticFactory2<String, String> = CjDiagnosticFactory2("CFIR_MACRO_EXPECT_MACRO_DEFINITION", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val MACRO_DEPENDENCY_COMPILE_FAILED: CjDiagnosticFactory3<String, String, String> = CjDiagnosticFactory3("CFIR_MACRO_DEPENDENCY_COMPILE_FAILED", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val MACRO_AMBIGUOUS_MATCH: CjDiagnosticFactory2<String, Collection<FqName>> = CjDiagnosticFactory2("CFIR_MACRO_AMBIGUOUS_MATCH", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val MACRO_CANNOT_FIND_DEPENDENCY_BCHIR: CjDiagnosticFactory2<String, String> = CjDiagnosticFactory2("CFIR_MACRO_CANNOT_FIND_DEPENDENCY_BCHIR", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val MACRO_EXPECT_PLAIN_MACRO: CjDiagnosticFactory2<String, String> = CjDiagnosticFactory2("CFIR_MACRO_EXPECT_PLAIN_MACRO", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val MACRO_EXPECT_ATTRIBUTED_MACRO: CjDiagnosticFactory2<String, String> = CjDiagnosticFactory2("CFIR_MACRO_EXPECT_ATTRIBUTED_MACRO", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val MACRO_EXPAND_ATEXCL: CjDiagnosticFactory2<String, String> = CjDiagnosticFactory2("CFIR_MACRO_EXPAND_ATEXCL", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val MACRO_INVALID_ATTR_TOKENS: CjDiagnosticFactory2<String, String> = CjDiagnosticFactory2("CFIR_MACRO_INVALID_ATTR_TOKENS", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val MACRO_INVALID_INPUT_TOKENS: CjDiagnosticFactory2<String, String> = CjDiagnosticFactory2("CFIR_MACRO_INVALID_INPUT_TOKENS", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val MACRO_INVALID_ESCAPE: CjDiagnosticFactory2<String, String> = CjDiagnosticFactory2("CFIR_MACRO_INVALID_ESCAPE", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    ...
    val MACRO_CANNOT_FIND_METHOD: CjDiagnosticFactory2<String, String> = CjDiagnosticFactory2("CFIR_MACRO_CANNOT_FIND_METHOD", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val MACRO_EVALUATE_FAILED: CjDiagnosticFactory2<String, String> = CjDiagnosticFactory2("CFIR_MACRO_EVALUATE_FAILED", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val MACRO_EXPAND_FAILED: CjDiagnosticFactory2<String, String> = CjDiagnosticFactory2("CFIR_MACRO_EXPAND_FAILED", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val MACRO_EXPAND_CODE_SHOULD_NOT_HAVE_MACROCALL: CjDiagnosticFactory2<String, String> = CjDiagnosticFactory2("CFIR_MACRO_EXPAND_CODE_SHOULD_NOT_HAVE_MACROCALL", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val MACRO_CALL_SAVE_FILE_FAILED: CjDiagnosticFactory2<String, String> = CjDiagnosticFactory2("CFIR_MACRO_CALL_SAVE_FILE_FAILED", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val MACRO_EXECUTOR_PROTOCOL_ERROR: CjDiagnosticFactory1<String> = CjDiagnosticFactory1("CFIR_MACRO_EXECUTOR_PROTOCOL_ERROR", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val MACRO_EXECUTOR_SERVER_DISCONNECTED: CjDiagnosticFactory1<String> = CjDiagnosticFactory1("CFIR_MACRO_EXECUTOR_SERVER_DISCONNECTED", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val MACRO_EXECUTOR_TIMEOUT: CjDiagnosticFactory1<String> = CjDiagnosticFactory1("CFIR_MACRO_EXECUTOR_TIMEOUT", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
    val MACRO_EXECUTOR_SERVER_CRASH: CjDiagnosticFactory1<String> = CjDiagnosticFactory1("CFIR_MACRO_EXECUTOR_SERVER_CRASH", Severity.ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
