...
import org.cangnova.cangjie.cfir.analysis.checkers.declaration.reportMissingProgramEntryIfNeeded
...
fun CfirSession.runCheckers(
    ...
    reportMissingProgramEntryIfNeeded(firFiles, this, diagnosticsCollector)
