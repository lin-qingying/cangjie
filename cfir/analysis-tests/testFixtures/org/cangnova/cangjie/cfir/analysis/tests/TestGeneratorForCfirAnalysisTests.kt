...
object TestGeneratorForCfirAnalysisTests {
    ...
    private fun renderSuite(
        ...
        appendLine("import org.cangnova.cangjie.cfir.analysis.tests.runners.AbstractPhasedDiagnosticLightTreeTest")
        appendLine("import org.cangnova.cangjie.test.JUnit3RunnerWithInners")
        ...
        appendLine("@RunWith(JUnit3RunnerWithInners::class)")
        appendLine("@OptIn(ObsoleteTestInfrastructure::class)")
        appendLine("@ObsoleteTestInfrastructure")
        appendLine("class CfirAnalysisDiagnosticsTestGenerated : AbstractPhasedDiagnosticLightTreeTest() {")
    ...
    private fun StringBuilder.appendDirectoryClass(
        ...
        appendLine("${indent}@RunWith(JUnit3RunnerWithInners::class)")
        appendLine("${indent}class $className : AbstractPhasedDiagnosticLightTreeTest() {")
