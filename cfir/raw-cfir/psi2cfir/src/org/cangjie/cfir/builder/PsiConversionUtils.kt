...
internal fun CjTypeReference?.toFirOrImplicitTypeRef(
    ...
    if (this == null) return CfirImplicitTypeRef.INSTANCE
    val typeElement = typeElement
        ?: return CfirImplicitTypeRef(source = toSource(this))
