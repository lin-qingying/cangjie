...
class RawCfirBuilderLazyBodiesByAstTestGenerated : AbstractRawCfirBuilderLazyBodiesByAstTest() {
    ...
    class Expressions : AbstractRawCfirBuilderLazyBodiesByAstTest() {
        ...
        @TestDataPath("\$PROJECT_ROOT")
        @RunWith(JUnit3RunnerWithInners::class)
        class Atomic : AbstractRawCfirBuilderLazyBodiesByAstTest() {
        ...
        @TestDataPath("\$PROJECT_ROOT")
        @RunWith(JUnit3RunnerWithInners::class)
        class Binary : AbstractRawCfirBuilderLazyBodiesByAstTest() {
        ...
        @TestDataPath("\$PROJECT_ROOT")
        @RunWith(JUnit3RunnerWithInners::class)
        class Interactions : AbstractRawCfirBuilderLazyBodiesByAstTest() {
        ...
        @TestDataPath("\$PROJECT_ROOT")
        @RunWith(JUnit3RunnerWithInners::class)
        class Lambda : AbstractRawCfirBuilderLazyBodiesByAstTest() {
        ...
        @TestDataPath("\$PROJECT_ROOT")
        @RunWith(JUnit3RunnerWithInners::class)
        class Postfix : AbstractRawCfirBuilderLazyBodiesByAstTest() {
        ...
        @TestDataPath("\$PROJECT_ROOT")
        @RunWith(JUnit3RunnerWithInners::class)
        class Prefix : AbstractRawCfirBuilderLazyBodiesByAstTest() {
        ...
        @TestDataPath("\$PROJECT_ROOT")
        @RunWith(JUnit3RunnerWithInners::class)
        class Type : AbstractRawCfirBuilderLazyBodiesByAstTest() {
