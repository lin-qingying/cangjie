...
- `compiler/chir/src/org/cangnova/cangjie/chir/core`
- `compiler/chir/tests/org/cangnova/cangjie/chir/core`
...
- Gap register: [chir-parity-gap-register.md](/D:/code/intellij/cangjie/compiler/chir/docs/chir-parity-gap-register.md)
