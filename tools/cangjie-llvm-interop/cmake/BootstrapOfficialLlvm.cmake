function(cangjie_bootstrap_official_llvm)
    ...
    if(NOT EXISTS "${cangjie_demangle_archive}")
        ...
        if(MSVC)
            message(WARNING "libcangjie-demangle.a is missing in official LLVM source; generating an empty compatibility file for MSVC builds.")
            file(WRITE "${cangjie_demangle_archive}" "")
        else()
